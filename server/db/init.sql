...
CREATE TABLE visit_tests (
    ...
    status VARCHAR(50) NOT NULL DEFAULT 'PENDING' CHECK (status IN ('PENDING', 'SAMPLE_COLLECTED', 'REJECTED', 'CANCELLED', 'IN_PROGRESS', 'AWAITING_APPROVAL', 'APPROVED', 'PRINTED', 'COMPLETED')),
